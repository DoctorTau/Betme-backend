...
public interface IBetService
{
    ...
    Task<Bet> GetBetByIdAsync(long id);
    /// <summary>
    /// Gets all participants of the bet.
    /// </summary>
    /// <param name="betId"> Id of the bet.</param>
    /// <returns>List of participants.</returns>
    Task<List<UserBet>> GetAllUsersOfBetAsync(long betId);
    /// <summary>
    /// Creates a new bet.
    /// </summary>
    ...
    Task<Bet> CreateBetAsync(BetCreatingDto bet, long userId);
    /// <summary>
